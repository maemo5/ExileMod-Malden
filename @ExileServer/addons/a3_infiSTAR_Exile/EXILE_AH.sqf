...
UPDATEEMAIL='chad143laryn@outlook.com';
INFISTARVERSION='05-12-2017 06-06-08 - v88';
...
diag_log format['<infiSTAR.de> %1 - VERSION: 05-12-2017 06-06-08 - v88',time];
{
	_x params ['_uids'];
	{
		private _uid = _x;
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [30042x2 - 05-12-2017 06-06-08 - v88 - %2 - %3]',time,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!   [30042x2 - 05-12-2017 06-06-08 - v88 - %2 - %3]',time,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = "
	...
	diag_log format['<infiSTAR.de>%1| %2   [05-12-2017 06-06-08 - v88]',_logname,_logentry];
";
...
_fnc_RandomGen =
{
	...
	_fnc_actualGen = {
		...
		_main	= ['a','e','2','2','7','9','5','2','0','5','5','e','6','b','5','2','9','d','a','d','9','e','4','a','c','5','4','9','b','4','7','2','e'];
...
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=15021';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
_devLog = format['infiSTAR.de AHAT %1 - 05-12-2017 06-06-08 - v88 - server running: %2:30042x2',VERSIONCHECKRESULT,time call FN_GET_TIME_TIME];diag_log _devLog;
"; if(!_HIDE_FROM_PLAYERS)then{ _asd = _asd + "
...
fn_infiSTAR_checkGlobalBanState = {
	...
	"; if(_USE_GLOBAL_BAN_CHECK)then{ _asd = _asd + "
		...
		"; }; _asd = _asd + "
	"; }else{ _asd = _asd + "
		_log = format['%1(%2) | GLOBAL BANNED PLAYER (NOT BANNED LOCALLY) | %3 [05-12-2017 06-06-08 - v88]',_name,_uid,time call FN_GET_TIME_TIME];
...
"; }; _asd = _asd + "
	...
	_log = format['%1(%2) | %3 | %4 [05-12-2017 06-06-08 - v88]',_name,_uid,_log,time call FN_GET_TIME_TIME];
