...
/****************************************************************************************************/
/****************************************************************************************************/
_response = "armalog" callExtension ("10dc98989050e&l=e227952055e6b529dad9e4ac549b472e&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> 0dc98989050e";
	diag_log "<infiSTAR.de> e227952055e6b529dad9e4ac549b472e";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("9"+"exile"+"§§"+_logname+"§§"+_logentry+"§§"+servername+"§§05-12-2017 06-06-08 - v88§§chad143laryn@outlook.com");
	};
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   [1000MS - 05-12-2017 06-06-08 - v88 - %2 - %3]',time,serverName,productVersion];
...
[] spawn {
	[["https://dll.infistar.de/remote.php?key=e227952055e6b529dad9e4ac549b472e"] call FN_ARMA_FETCHDATA] call {
		_this params [
			["_ret","",[""]]
		];
