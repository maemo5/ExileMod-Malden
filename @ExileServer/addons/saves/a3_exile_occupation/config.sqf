...
SC_randomSpawnMaxGroups        	= 10;                    	// Maximum amount of random AI groups allowed at any time
SC_randomSpawnMinGroupSize      = 5;                    	// Minimum amount of random AI groups allowed per group
...
SC_HeliCrashGuards          	= 10;                    	// number of AI to spawn at each crate
