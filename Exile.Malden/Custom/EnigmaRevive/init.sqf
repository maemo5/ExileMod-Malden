...
MaxRevivesAllowed = 10; //Set the max number of revives permitted per life. I recomend you keep it at 1. Just saying...
...
"EnigmaReviveMSG" addPublicVariableEventHandler {
   ...
   _msg = _packet select 0;
	...
	sleep 10;
	systemChat ""; //Please leave this line as a way of saying thanks to me! :D HAPPYD
};
