...
class CfgExileCustomCode
{
	...
	ExileClient_object_player_event_onEnterSafezone = "R3F_LOG\ExileClient_object_player_event_onEnterSafezone.sqf";
	...
	ExileClient_object_player_bambiStateBegin = "overrides\ExileClient_object_player_bambiStateBegin.sqf";
};
...
class CfgTerritories
{
	...
	prices[] =
	{
		...
		{5000,					150,			300 					}, // Level 1
		{5000,					150,			300 					}// Level 2
	};
